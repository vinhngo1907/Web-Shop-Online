<?php 
	...
	if(isset($_POST['send_contact'])){
        ...
        // $status = $_POST['status'];
        get_contact($hoten,$email,$phone,$title,$content);
	}
?>
		...
		<div class="col-md-7 col-12">
			<div class="section-article contactpage" style="  padding-left: 20px;">
					...
					<div class="form-comment">
						<div class="row" style="padding-left: 14px;">
							<div class="col-md-4 col-12">
								<div class="form-group" style="width: 200px;">
									...
									<input id="name" name="hoten" type="text" value="" class="form-control">
								</div>
							</div>
							<div class="col-md-4 col-12">
								<div class="form-group" style="width: 200px;">
						...
						<button type="submit" class="btn-update-order" name="send_contact">Gửi nhận xét</button>
